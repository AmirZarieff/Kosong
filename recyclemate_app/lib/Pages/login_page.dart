      ...
      body: Container(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [Color.fromARGB(255, 39, 176, 39), Color(0xFF2196F3)],
          ),
        ),
        child: Center(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        errorBorder: OutlineInputBorder(
                          ...
                          borderSide: BorderSide(
                            color:
                                Colors.white, // Keep white border even in error
                            width: 1.5,
                          ),
                        ),
                        focusedErrorBorder: OutlineInputBorder(
                          ...
                          borderSide: BorderSide(
                            color: Colors
                                .white, // Keep white border even in focused error
                            width: 2,
                          ),
                        ),
                        errorStyle: TextStyle(
                          color:
                              Colors.redAccent, // White text for error message
                          fontSize: 14,
                          fontWeight: FontWeight.bold,
                        ),
                        hintText: 'Password',
